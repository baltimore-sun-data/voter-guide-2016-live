...
function stateLink() {
	...
	if(location.href == "http://data.baltimoresun.com/voter-guide-2016/index.html?senate"){
	      $("#city-races").hide();
	      $("#state-races").show();
...
function populateData(data, race) {
  ...
  for (var key in data){
	 ...
	 if(data[key]["party"] == "Democrat") {
		...
		if(data[key]["q1"] == "") {
			var questionaireLink = "<div class='notoggle ltgreybg'>NO QUESTIONNAIRE SUBMITTED"
				...
				questionaireLink = "<div class='toggle bluebg'>+ Sun Editorial Questionnaire"
			};      	
	...
	if (data[key]["twitter"] == "") {
			...
			twitterLink +="\"><span class=\"icon-twitter blue\"></a></span>";
			};
	...
	if (data[key]["facebook"] == "") {
			...
			facebookLink += "\"><span class=\"icon-facebook blue\"></a></span></li>";
			};
	...
	if (data[key]["website"] == "") {
			...
			websiteLink += "\"><span class=\"icon-globe blue\"></a></span>";	
			};
	...
	code += '<div class="cand-name race blue">' + data[key]["candidateName"] +'</div>';
	code += '<div class="cand-details"><ul>';
	code += websiteLink;
	code += twitterLink;
	code += facebookLink;
	code += '<li><span class="party blue">' + data[key]["party"] +'</span></li>';
	code += age;
	code += livesIn;
	code += '<span class="bio race"><p>' + data[key]["bio"] +'</p></span></ul></div>';
	code += questionaireLink + '</div>';
	code += '<div class="questionaire" style="display:none;">';
	code += questionaire
	code += '<div style="clear:both;"></div><a href="#' + data[key]["candidateLastName"].replace(/\s+/g, '-').replace(/\./g,'').toLowerCase() + '" class="top-blue">&#8593; TOP</a></div>';
...
// Loop through and populate republican candidates
  	...
  	if(data[key]["party"] == "Republican") {
			...
			if(data[key]["q1"] == "") {
				...
				questionaireLink = "<div class='toggle redbg'>+ Sun Editorial Questionnaire"
			}; 
	...
	if (data[key]["twitter"] == "") {
			...
			var twitterLink = "<span class=\"twitter\"><a target=\"_new\" href=\"http://www.twitter.com/";
			twitterLink += data[key]["twitter"]; 
			twitterLink +="\"><span class=\"icon-twitter red\"></a></span>";
			};
	...
	if (data[key]["facebook"] == "") {
			...
			var facebookLink = "<span class=\"facebook\"><a target=\"_new\" href=\"http://www.";
			facebookLink += data[key]["facebook"];
			facebookLink += "\"><span class=\"icon-facebook red\"></a></span></li>";
			};
	...
	if (data[key]["website"] == "") {
			...
			var websiteLink = "<li><span class=\"website\"><a target=\"_new\" href=\"http://www.";
			websiteLink += data[key]["website"];
			websiteLink += "\"><span class=\"icon-globe red\"></a></span>";	
			};
...
//If photo is blank, here is how to handle	
	...
	code += candidatePhoto;
	code += '<div class="cand-bio-text">';
	code += '<div class="cand-name race red">' + data[key]["candidateName"] +'</div>';
	code += '<div class="cand-details"><ul>';
	code += websiteLink;
	code += twitterLink;
	code += facebookLink;
	code += '<li><span class="party red">' + data[key]["party"] +'</span></li>';
	code += age;
	code += livesIn;
	code += '<span class="bio race"><p>' + data[key]["bio"] +'</p></span></ul></div>';
	code += questionaireLink + '</div>';
	code += '<div class="questionaire" style="display:none;">';
	code += questionaire
	code += '<div style="clear:both;"></div><a href="#' + data[key]["candidateLastName"].replace(/\s+/g, '-').replace(/\./g,'').toLowerCase() + '" class="top-red">&#8593; TOP</a>';
	code += '</div></div></div> <!-- /cand-bio --><div class="clear"></div>';
